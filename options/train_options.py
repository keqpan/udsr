...
class TrainOptions(BaseOptions):
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--path_to_intr', type=str, default='/data/unpaired_depth/Scannet_meta/', help='max_distance')
        parser.add_argument('--save_image_folder', type=str, default='/root/code_for_article/depth_SR/test_pred/', help='max_distance')
...
#         parser.add_argument('--path_B', type=str, default='/mnt/neuro/depth/NYUv2/NYUv2/depth', help='path_B')
        parser.add_argument('--path_A', type=str, default='/data/unpaired_depth/Scannet_ssim/trainB/full_size/hr', help='path_B')
        parser.add_argument('--path_B', type=str, default='/data/unpaired_depth/Scannet_ssim/trainA/full_size/depth', help='path_B')
...
#         parser.add_argument('--path_B_test', type=str, default='/mnt/neuro/depth/NYUv2/NYUv2/depth_test', help='path_B_test')
        parser.add_argument('--path_A_test', type=str, default='/data/unpaired_depth/Scannet_ssim/testB/full_size/depth', help='path_B_test')
        parser.add_argument('--path_B_test', type=str, default='/data/unpaired_depth/Scannet_ssim/testA/full_size/depth', help='path_B_test')
...
#         parser.add_argument('--B_add_paths', type=str, default='/mnt/neuro/depth/NYUv2/NYUv2/img', help='path_B_test')
        parser.add_argument('--A_add_paths', type=str, default='/data/unpaired_depth/Scannet_ssim/trainB/full_size/img', help='path_B_test')  
        parser.add_argument('--B_add_paths', type=str, default='/data/unpaired_depth/Scannet_ssim/trainA/full_size/img', help='path_B_test')     
...
#         parser.add_argument('--B_add_paths_test', type=str, default='/mnt/neuro/depth/NYUv2/NYUv2/img_test', help='path_B_test')
        parser.add_argument('--A_add_paths_test', type=str, default='/data/unpaired_depth/Scannet_ssim/testB/full_size/img', help='path_A_test')
        parser.add_argument('--B_add_paths_test', type=str, default='/data/unpaired_depth/Scannet_ssim/testA/full_size/img', help='path_B_test')
